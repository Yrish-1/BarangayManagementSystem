...
{
    public partial class AdminForm5 : Form
    {
        public AdminForm5()
        {
            InitializeComponent();
        ...
        #region MenuButtonsClickEvents

        private void btDashboard_Click(object sender, EventArgs e)
        {
            OpenChildForm(new DashboardAdF5());
        }

        private void btReportApproval_Click(object sender, EventArgs e)
        {
            OpenChildForm(new ReportApprovalAdF5());
        }

        private void btResidents_Click(object sender, EventArgs e)
        {
            OpenChildForm(new ResidentsAdF5());
        }

        private void btManageStaff_Click(object sender, EventArgs e)
        {
            OpenChildForm(new ManageStaffAdF5());
        }

        private void btPopulationRep_Click(object sender, EventArgs e)
        {
            OpenChildForm(new PopulationReportAdF5());
        }

        private void btAnnouncements_Click(object sender, EventArgs e)
        {
            OpenChildForm(new AnnouncementsAdF5());
        }

        private void btSettings_Click(object sender, EventArgs e)
        {
            OpenChildForm(new SettingsAdF5());
        }
