...
namespace EveryJuanCount
{
    public partial class SubmitReport : Form
    {
        ...
        private void btUploadFile_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("File is too large. Maximum allowed size is 5MB.",
        ...
        private void btSubmit_ReportF3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please fill in the First Name and Last Name of the person involved.",
            ...
            // Save to DATABASE
            DatabaseHelper.SaveReport(report, SessionData.CurrentResidentId);

            // Also keep in SessionData for current session
